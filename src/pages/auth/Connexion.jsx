...
export const Connexion = () => {
  return (
    ...
    <div className='flex flex-col justify-center items-center w-2/4'>
     ...
     <input className='w-full m-5 p-3 bg-slate-200' type="text"  placeholder='Entrer votre prenom'/>
     <input className='w-full m-5 p-3 bg-slate-200' type="email"  placeholder='Entrer votre Adresse Email'/>
